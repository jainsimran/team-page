            ...
            `<div class="col-lg-4 col-xs-12 col-md-6 text-center mt-4">
                <div class="card">
                    <div class="px-3 pt-4 pb-1">
                        <img src="img/coaches/${COACH_LIST[i].image}" class="card-image" alt="${COACH_LIST[i].name}" />
                    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4 text-center">
                    <img src="img/coaches/${COACH_LIST[index].image}" class="modal-image" id="headshot-modal"/>
